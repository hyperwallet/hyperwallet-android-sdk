...
public class VenmoAccountQueryParamTest {
    ...
    @Test
    public void testVenmoAccountQueryParam_withUrlQueryMap() {
        ...
        assertThat(queryParam.getType(), is(VENMO_ACCOUNT));
    ...
    public void testPayPalAccountQueryParam_verifyDefaultValues() {
        VenmoAccountQueryParam queryParam = new VenmoAccountQueryParam.Builder().build();
    ...
    public void testBuildQuery_verifyDefaultValues() {
        QueryParam queryParam = new VenmoAccountQueryParam.Builder().build();
        ...
        assertThat(query.get(TRANSFER_METHOD_TYPE), is(VENMO_ACCOUNT));
    ...
    public void testBuildQuery_returnsQueryParameters() {
        ...
        assertThat(resultQuery.get(TRANSFER_METHOD_TYPE), is(VENMO_ACCOUNT));
    }
