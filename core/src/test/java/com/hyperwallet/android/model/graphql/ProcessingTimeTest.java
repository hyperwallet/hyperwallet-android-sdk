...
public class ProcessingTimeTest {
    ...
    @Test
    public void testProcessingTime_NonEquals() throws JSONException {
        ProcessingTime firstProcessingTime = new ProcessingTime(new JSONObject("{\n"
                + "  \"transferMethodType\": \"BANK_CARD\",\n"
                + "  \"country\": \"CA\",\n"
                + "  \"currency\": \"USD\",\n"
                + "  \"value\": \"1-3 Business days\"\n"
        ...
        ProcessingTime secondProcessingTime = new ProcessingTime(new JSONObject("{\n"
                + "  \"transferMethodType\": \"BANK_CARD\",\n"
                + "  \"country\": \"US\",\n"
                + "  \"currency\": \"USD\",\n"
                + "  \"value\": \"1-3 Business days\"\n"
                + "}"));
        assertThat(firstProcessingTime.equals(secondProcessingTime), is(false));
    }
}