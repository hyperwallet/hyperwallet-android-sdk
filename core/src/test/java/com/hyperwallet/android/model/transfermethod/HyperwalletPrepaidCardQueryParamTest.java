...
public class HyperwalletPrepaidCardQueryParamTest {
    ...
    public void testHyperwalletPrepaidCardQueryParam_verifyDefaultValues() {
        HyperwalletPrepaidCardQueryParam queryParam = new HyperwalletPrepaidCardQueryParam.Builder().build();
    ...
    public void testBuildQuery_verifyDefaultValues() {
        QueryParam queryParam = new HyperwalletPrepaidCardQueryParam.Builder().build();
