...
public class StatusTransitionTest {
    ...
    public void testFromJsonString_convertStatusTransition() throws Exception {
        ...
        assertThat(statusTransition.getToken(), is(equalTo("sts-fake-token")));
    ...
    public void testStatusTransition_isParcelable() throws Exception {
        ...
        assertThat(statusTransition.getToken(), is("sts-fake-token"));
        ...
        assertThat(bundledStatusTransition.getToken(), is("sts-fake-token"));
