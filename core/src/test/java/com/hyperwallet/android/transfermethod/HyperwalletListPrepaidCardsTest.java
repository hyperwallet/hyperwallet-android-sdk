...
public class HyperwalletListPrepaidCardsTest {
    @Rule
    ...
    @Mock
    private HyperwalletListener<HyperwalletPageList<HyperwalletPrepaidCard>> mListener;
    @Captor
    private ArgumentCaptor<HyperwalletPageList<HyperwalletPrepaidCard>> mListTransferMethodCaptor;
    @Captor
    ...
    public void testListPrepaidCards_returnsActivatedCards() throws InterruptedException {
        ...
        HyperwalletPrepaidCardQueryParam queryParam = new HyperwalletPrepaidCardQueryParam.Builder()
                .status(ACTIVATED)
                .build();
        ...
        HyperwalletPageList<HyperwalletPrepaidCard> hyperwalletPrepaidCardsResponse =
        ...
        HyperwalletPrepaidCard hyperwalletPrepaidCard = hyperwalletPrepaidCardsResponse.getDataList().get(0);
    ...
    public void testListPrepaidCards_returnsError() throws InterruptedException {
        ...
        HyperwalletPrepaidCardQueryParam actualPrepaidCard = new HyperwalletPrepaidCardQueryParam.Builder()
                .status(ACTIVATED)
                .build();
