...
public class HyperwalletListTransfersTest {
    @Rule
    ...
    @Mock
    private HyperwalletListener<HyperwalletPageList<Transfer>> mListener;
    @Captor
    private ArgumentCaptor<HyperwalletPageList<Transfer>> mCaptor;
    @Captor
    ...
    public void testListTransfers_returnsTransfers() throws InterruptedException {
        ...
        assertThat(transfer.getSourceToken(), is("usr-12345"));
        assertThat(transfer.getSourceAmount(), is("90.13"));
        assertThat(transfer.getSourceCurrency(), is("CAD"));
        assertThat(transfer.getDestinationToken(), is("trm-123456"));
    ...
    public void testListTransfers_returnsNoTransfers() throws InterruptedException {
        ...
        HyperwalletPageList<Transfer> receiptsResponse = mCaptor.getValue();
    ...
    public void testListTransfers_returnsError() throws InterruptedException {
        ...
        verify(mListener, never()).onSuccess(ArgumentMatchers.<HyperwalletPageList<Transfer>>any());
